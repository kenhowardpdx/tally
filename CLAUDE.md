...
This file provides context and guidelines for AI assistants working on the Tally project.
...
```hcl
# NEVER DO THIS
bucket = "terraform-state-123456789012"  # Hardcoded account ID
profile = "AdministratorAccess-123456789012"  # Hardcoded account ID
```
